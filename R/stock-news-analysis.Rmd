...
reddit2$Score_1 <- sentiment(c(reddit2$News_1))
reddit2$Score_2 <- sentiment(c(reddit2$News_2))
reddit2$Score_3 <- sentiment(c(reddit2$News_3))
reddit2$Score_4 <- sentiment(c(reddit2$News_4))
reddit2$Score_5 <- sentiment(c(reddit2$News_5))
reddit2$Score_6 <- sentiment(c(reddit2$News_6))
reddit2$Score_7 <- sentiment(c(reddit2$News_7))
reddit2$Score_8 <- sentiment(c(reddit2$News_8))
reddit2$Score_9 <- sentiment(c(reddit2$News_9))
...
# reddit3 <- reddit2 %>%
#   select(27:29) %>%
#   transmute(Total = sum(.[,2:4], na.rm=TRUE))
